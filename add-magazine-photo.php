...
include_once "create-magazine.class.php";

$create = new create_magazine;
...
if(isset($_FILES['imagefiles']['name'])&& !empty($_FILES['imagefiles']['name'])&& !empty($_FILES['imagefiles']['size'])){
	 if( is_uploaded_file($_FILES['imagefiles']['tmp_name'])){
		...
		if(move_uploaded_file($tmp_name,$img_dir.$_FILES['imagefiles']['name'])){
		  ...
		  $create->insertparameters($magname,$magphoto,$magdate);
    ...
    <div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			  <h1 class="page-header">Add Magazine Photo</h1>
               <div class="row">
               <div class="col-md-12">
               <div class="form-group col-md-8">
			<form role="form" action="" method="post" enctype="multipart/form-data"/>
               <label for="Magname">Magazine Name</label>
<input type="text"  name="magname" value="<?php if(isset($error)){echo $_POST['magname'];}?>" class="form-control" placeholder="Enter Magazine Name">
								</div>
					<div class="form-group col-md-8">
