...
$stmt = $mdb->mysqli->query('SELECT postid,postcategory,postitle,postbody,postphoto FROM postnews WHERE postcategory="Black Models" ORDER BY postid DESC LIMIT 6', MYSQLI_USE_RESULT);
$count4= 0;
while($data=$stmt->fetch_array(MYSQLI_ASSOC)){
	   $dataid[] = $data['postid'];
...
<div class="col-sm-12 blog-main" id="link1">
  ...
  <div class="col-sm-4 col-md-12" style="margin-bottom:40px;">
        <div class="thumbnail">
