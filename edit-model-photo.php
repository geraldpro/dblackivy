...
$stmt=$mdb->mysqli->prepare("UPDATE model SET fname=?, mname=?, lname=?, address=?, phone=?, modelphoto=? WHERE modelid =?");
$stmt-> bind_param('ssssssd',$fname,$mname,$lname,$address,$phone,$modelphoto,$modelid);
...
if(is_numeric($id)){
$count=0;$count++;
$stmt=$mdb->mysqli->query("SELECT modelid,fname, mname, lname, address, phone, modelphoto FROM model WHERE modelid = $id",MYSQLI_USE_RESULT);
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			  <h1 class="page-header">Add Model Photo</h1>
				...
				<div class="row placeholders" style="text-align:left;">
					...
					<input type="text"  name="fname" value="<?php if(isset($_GET['id'])){echo $fname;} ?>" class="form-control" placeholder="Enter First Name">
								</div>
							</div>
							<div class="col-md-12 ">
								<div class="form-group col-md-8">
									<label for="albumname">Middle Name</label>
				<input type="text"  name="mname" value="<?php if(isset($_GET['id'])){echo $mname;} ?>" class="form-control" placeholder="Enter Middle Name">
								</div>
							</div>
                            <div class="col-md-12 ">
								<div class="form-group col-md-8">
									<label for="albumname">Last Name</label>
	<input type="text"  name="lname" value="<?php if(isset($_GET['id'])){echo $lname;} ?>" class="form-control" placeholder="Enter Last Name">
								</div>
							</div>
  ...
  <div class="col-md-12 ">
	<div class="form-group col-md-8">
		<label for="albumname">Contact Address</label>
			<input type="text"  name="address" value="<?php if(isset($_GET['id'])){echo $address;} ?>" class="form-control" placeholder="Enter Contact Address">
			</div>
					</div>
                      <div class="col-md-12 ">
	                    <div class="form-group col-md-8">
		                  <label for="albumname">Phone Number</label>
	<input type="text"  name="phone" value="<?php if(isset($_GET['id'])){echo $phone;} ?>" class="form-control" placeholder="Enter Phone Number">
		                </div>
	                  </div>
...
<a href="#"><?php if(isset($_GET['id'])){echo "<img src=http://localhost/dblackivy/model_images/".$modelphoto."> <br>";} ?></a>		 
                             ...
                             <div class="col-md-12">
								<div class="form-group col-md-8">
									<label for="exampleInputFile">Choose a New Photo Image</label>
