...
$stmt=$mdb->mysqli->query('SELECT modelid,fname, mname, lname, address, phone, modelphoto FROM model ORDER BY modelid DESC',MYSQLI_USE_RESULT);
$count= 0;
...
<html lang="en">
  ...
  <title>Manage-model-photo-list -- Black Ivy</title>
  <!-- Bootstrap core CSS -->
    ...
    <div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			  <h1 class="page-header">Manage Model Photo List</h1>
								  ...
								  <div class="col-sm-12">
                                    ...
                                    <?php for($i=0; $i<$count; $i++){ ?>
										<div class="col-sm-4 col-md-3">
											<div class="thumbnail">
				<a href="#"><?php echo "<img src=http://localhost/dblackivy/model_images/".$modelphoto[$i]."> <br>" ?></a>
												<div class="caption">
								<h6 style="text-align:center;"><b><?php echo  $fname[$i];?></b></h6>
						       <small> <?php echo $mname[$i]; ?></small><br>
                        	 <small> <?php echo $lname[$i]; ?></small><br>
						<small> <?php echo $address[$i]; ?></small><br>
                        <small> <?php echo $phone[$i]; ?></small><br>


	
<p style="text-align:center;"><a href="delete-model-photo.php?id=<?php echo $modelid[$i];?>" class="label label-danger" type="button">Delete</a>
<a href="edit-model-photo.php?id=<?php echo $modelid[$i];?>"class="label label-warning" type="button">Edit</a></p>
												</div>
											</div>
										</div>
                                        <?php }?>
