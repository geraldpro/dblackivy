...
$stmt=$mdb->mysqli->query('SELECT bannerid,bannername,bannerphoto,bannerdate FROM banner ORDER BY bannerid DESC',MYSQLI_USE_RESULT);
$count= 0;
    ...
    <div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			  <h1 class="page-header">Manage Banner Photo List</h1>
								  ...
								  <div class="col-sm-12">
                                    ...
                                    <?php for($i=0; $i<$count; $i++){ ?>
										<div class="col-sm-4 col-md-3">
											<div class="thumbnail">
		<a href="#"> <?php echo "<img src=http://localhost/dblackivy/banner_images/".$bannerphoto[$i]."> <br>" ?></a>
												<div class="caption">
						       <small> <?php echo $bannername[$i]; ?></small><br>
                        	 <small> <?php echo $bannerdate[$i]; ?></small><br>
						

	
<p style="text-align:center;"><a href="delete-banner-photo.php?id=<?php echo $bannerid[$i];?>" class="label label-danger" type="button">Delete</a>
<a href="edit-banner-photo.php?id=<?php echo $bannerid[$i];?>"class="label label-warning" type="button">Edit</a></p>
												</div>
											</div>
										</div>
                                        <?php }?>
