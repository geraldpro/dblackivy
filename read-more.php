...
$mdb = new connect;
//selects article posts by id
$select = $mdb->mysqli->query("SELECT postid,postcategory,postitle,postbody,postphoto FROM postnews WHERE postid = $id", MYSQLI_USE_RESULT);
  ...
  <head>
   ...
   <body>
	...
	<div class="container-fluid">
        ...
        <div class="caption">
        <h2 class="blog-post-title" id="link1"><b><?php  if(isset($_GET['id'])){echo strtoupper($datatitle); }?></b></h2>
      </div>
                <div class="thumbnail" style="margin-top:20px;">

      <a href="#"><?php if(isset($_GET['id'])){echo "<img src=http://dblackivy.com/post_images/".$dataphoto."> <br>"; }?></a>
            </div>
		  <div class="media">
                   <p id="link1"><?php if(isset($_GET['id'])){echo  $datacontent ;}?></p>
