...
$stmt=$mdb->mysqli->query('SELECT advertid,advertname,advertphoto,advertdate FROM advert ORDER BY advertid DESC',MYSQLI_USE_RESULT);
$count= 0;
    ...
    <div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			  <h1 class="page-header">Manage Advert Photo List</h1>
				...
				<a href="#"> <?php echo "<img src=http://localhost/dblackivy/advert_images/".$advertphoto[$i]."> <br>" ?></a>
												<div class="caption">
						       <small> <?php echo $advertname[$i]; ?></small><br>
                        	 <small> <?php echo $advertdate[$i]; ?></small><br>
						

	
<p style="text-align:center;"><a href="delete-advert-photo.php?id=<?php echo $advertid[$i];?>" class="label label-danger" type="button">Delete</a>
<a href="edit-advert-photo.php?id=<?php echo $advertid[$i];?>"class="label label-warning" type="button">Edit</a></p>
												</div>
											</div>
										</div>
                                        <?php }?>
