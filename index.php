...
<html lang="en">
   ...
   <body>
	...
	<div class="container-fluid">
		...
		<div class="row">
           ...
           <a href="#"> <?php echo "<img src=http://localhost/dblackivy/banner_images/".$bannerphoto."> <br>" ?></a>
            </div>
 ...
 <h4 style="margin-top:-10px;"><a href="read-more.php?id=<?php echo $dataid[$i] ;?>"><?php echo strtoupper($datatitle[$i]);?></a></h4>          <p><?php echo substr($datacontent[$i],0,60);?>....</p>
...
<div class="col-sm-4 col-md-4" style="margin-bottom:40px;">
        <div class="thumbnail">
       <a href="#"><?php echo "<img src=http://localhost/dblackivy/model_images/".$modelphoto."> <br>" ?></a>
          	</div>
            </div>	
...
<h2 class="blog-title" id="style" style="margin-bottom:20px; text-align:center;">FEATURED POSTS</b></h2>
  ...
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <a href="#"><?php echo "<img src=http://localhost/dblackivy/post_images/".$dataphoto[$i]."> <br>"; ?></a>
      <div class="caption text-center">
 <p style="color:#DAA520; margin-bottom:15px; font-size:12px;"><strong><?php echo strtoupper($datacategory[$i]); ?></strong></p>        <h4 style="margin-top:-10px;"><a href="read-more.php?id=<?php echo $dataid[$i] ;?>"><?php echo strtoupper($datatitle[$i]);?></a></h4>        
